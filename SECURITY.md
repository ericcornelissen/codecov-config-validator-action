...
The table below shows which versions of the _Codecov Config Validator Action_
...
to [security@ericcornelissen.dev] and include the terms "SECURITY" and "codecov
config validator action" in the subject line. Please do not open a regular issue
or Pull Request in the public repository.
